...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgxProgressComponent = /** @class */ (function () {
                function NgxProgressComponent(progressService, self, register) {
                ...
                NgxProgressComponent.prototype.ngOnDestroy = function () {
                    this.register.unregisterBar(this.self.nativeElement);
                };
                NgxProgressComponent.prototype.ngOnInit = function () {
                    this.register.registerBar(this.self.nativeElement);
                };
                return NgxProgressComponent;
            }());
            NgxProgressComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgxProgressInterceptor = /** @class */ (function () {
                function NgxProgressInterceptor(progressService) {
                    this.progressService = progressService;
                }
                NgxProgressInterceptor.prototype.intercept = function (request, next) {
                    var _this = this;
                ...
                return NgxProgressInterceptor;
            }());
            NgxProgressInterceptor.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /***********************     HTTP ONLY         **************************/
            var NgxProgressOnlyHttpModule = /** @class */ (function () {
                function NgxProgressOnlyHttpModule() {
                }
                return NgxProgressOnlyHttpModule;
            }());
            ...
            var NgxProgressOnlyRouterModule = /** @class */ (function () {
                function NgxProgressOnlyRouterModule(router, progressService) {
                    this.progressService = progressService;
                    initRouter(router, progressService);
                }
                return NgxProgressOnlyRouterModule;
            }());
            NgxProgressOnlyRouterModule.ctorParameters = function () { return [
            ...
            var NgxProgressModule = /** @class */ (function () {
                function NgxProgressModule(router, progressService) {
                    this.progressService = progressService;
                    initRouter(router, progressService);
                }
                return NgxProgressModule;
            }());
            NgxProgressModule.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _ngx_progress_service__WEBPACK_IMPORTED_MODULE_3__["NgxProgressService"] }
            ]; };
            ...
            /*******************         ONLY PROGRESSBAR          ********************/
            var NgxProgressOnlyBarModule = /** @class */ (function () {
                function NgxProgressOnlyBarModule() {
                }
                return NgxProgressOnlyBarModule;
            }());
            ...
            /*****************************************************************************************/
            var getCurrentNavigationState = function (router) {
            ...
            var initRouter = function (router, progressService) {
                router.events.subscribe(function (event) {
                    var state = getCurrentNavigationState(router);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgxProgressService = /** @class */ (function () {
                function NgxProgressService(vendorBarService) {
                 ...
                 */
                NgxProgressService.prototype.start = function () {
                 ...
                 */
                NgxProgressService.prototype.end = function () {
                    var _this = this;
                    this.progressCount--;
                    setTimeout(function () {
                        if (_this.progressCount === 0) {
                            _this.vendorBarService.complete();
                            _this.isStarted = false;
                            _this.endEmitter.next();
                        }
                    }, 200);
                };
                /**
                 ...
                 */
                NgxProgressService.prototype.reset = function () {
                    this.vendorBarService.start();
                    this.isStarted = true;
                    this.progressCount++;
                    this.startEmitter.next();
                 ...
                 */
                NgxProgressService.prototype.terminate = function () {
                    this.vendorBarService.complete();
                    this.isStarted = false;
                    this.endEmitter.next();
                };
                return NgxProgressService;
            }());
            NgxProgressService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterService = /** @class */ (function () {
                ...
                RegisterService.prototype.registerBar = function (bar) {
                    this.existingBars.push(bar);
                };
                RegisterService.prototype.unregisterBar = function (bar) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VendorComponent = /** @class */ (function () {
                function VendorComponent(loader) {
                    this.loader = loader;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VendorService = /** @class */ (function () {
                function VendorService(platformId) {
                    var _this = this;
                    ...
                    this.progress$ = this.state$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (s) { return _this.timer$(s); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (s) { return s.value; }));
                    this.timer$ = function (s) {
                        var state$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(s);
                        if (!Object(_angular_common__WEBPACK_IMPORTED_MODULE_4__["isPlatformBrowser"])(_this.platformId)) {
                            ...
                            state$ =
                                s.value === 0
                                    ...
                                    : Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(0, 500).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (t) { return ({ requests: 0, value: t === 1 ? 0 : 100 }); }));
                        }
                        else if (s.requests) {
                            state$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(0, 250).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (t) { return (t === 0 ? Object.assign({}, s) : Object.assign({}, s, { value: _this._increment() })); }));
                        }
                        return state$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (next) {
                            _this.setState(next, false);
                        }));
                    };
                }
                VendorService.prototype.start = function (initialValue) {
                ...
                VendorService.prototype.stop = function () {
                    this.setState({ requests: 0 });
                };
                VendorService.prototype.complete = function () {
                 ...
                 */
                VendorService.prototype.set = function (n) {
                 ...
                 */
                VendorService.prototype.increment = function (rnd) {
                    if (rnd === void 0) { rnd = 0; }
                    this.set(this._increment(rnd));
                };
                Object.defineProperty(VendorService.prototype, "state", {
                    get: function () {
                ...
                VendorService.prototype.setState = function (state, emitEvent) {
                    var _this = this;
                    if (emitEvent === void 0) { emitEvent = true; }
                    emitEvent
                        ? this.state$.next(Object.assign({}, this.state$.value, state))
                        : Object.keys(state).forEach(function (prop) { return (_this.state[prop] = state[prop]); });
                };
                VendorService.prototype._increment = function (rnd) {
                    if (rnd === void 0) { rnd = 0; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var handleRoute = function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({ status: 200 })); };
            var FakeHttpInterceptor = /** @class */ (function () {
                function FakeHttpInterceptor() {
                }
                FakeHttpInterceptor.prototype.intercept = function (request, next) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormTestComponent = /** @class */ (function () {
                function FormTestComponent(http) {
                    this.http = http;
                }
                FormTestComponent.prototype.fakeRequest = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.http.get('https://github.com/kKen94/ngx-progress').toPromise()];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
            ...
            FormTestComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
            var LoganComponent = /** @class */ (function () {
                function LoganComponent() {
                }
                return LoganComponent;
            }());
